...
Loop:
    XOR C, C, D         ; 07 01110ddd 0xxx1100
    XOR C, C, D         ; 08 01110ddd 0xxx1100
    XOR B, B, S         ; 09 01110ddd 0xxx1101
    XOR B, B, S         ; 0a 01110ddd 0xxx1101
    XOR A, A, L         ; 0b 01110000 00001110
    XOR A, A, L         ; 0c 01110000 00001110
    JMP Loop            ; 0d 10000111 00000111
```
...
Loop:
    ...
    ADD L, L, 1  ; 02: 01001ddd ixxxryyy
    SHR S, S     ; 03: 01111101 01011100
    ADC A, A, 0  ; 04: 01000000 10001000
    SHR S, S     ; 05: 01111101 01011100
    ADC B, B, 0  ; 06: 01000001 10011000
    SHR S, S     ; 07: 01111101 01011100
    ADC C, C, 0  ; 08: 01000010 10101000
    SHR S, S     ; 09: 01111101 01011100
    ADC D, D, 0  ; 0a: 01000011 10111000
    SHR S, S     ; 0b: 01111101 01011100
    ADC M, M, 0  ; 0c: 01000100 11001000
